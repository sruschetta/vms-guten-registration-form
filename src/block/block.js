...
registerBlockType( 'vms/block-vms-gluten-registration-form', {
	...
	title: 'vms-gluten-registration-form',
	icon: 'shield',
	category: 'widgets',
	attributes: {
	...
	save: class extends Component {
		  ...
		  render() {
		      return (
						<div>
							{this.props.attributes.firstname_placeholder}<br/>
							{this.props.attributes.lastname_placeholder}<br/>
							{this.props.attributes.email_placeholder}<br/>
							{this.props.attributes.password_placeholder}<br/>
							{this.props.attributes.password2_placeholder}<br/>
							{this.props.attributes.nation_placeholder}<br/>
							{this.props.attributes.age_placeholder}<br/>
							{this.props.attributes.submit_button_label}<br/>
						</div>
		      );
		  }
		},
